...
export interface ValidatedEnv {
  ...
  NEXT_PUBLIC_FEATURE_SWAP_WS_ENABLED?: string;
  NEXT_PUBLIC_FEATURE_EXPERIMENTAL_SWAP_UI?: string;
  NEXT_PUBLIC_FEATURE_EXPERIMENTAL_MARKETPLACE_FILTERS?: string;
...
export function validateEnv(): ValidatedEnv {
  ...
  return {
    ...
    NEXT_PUBLIC_FEATURE_SWAP_WS_ENABLED: process.env.NEXT_PUBLIC_FEATURE_SWAP_WS_ENABLED,
    NEXT_PUBLIC_FEATURE_EXPERIMENTAL_SWAP_UI: process.env.NEXT_PUBLIC_FEATURE_EXPERIMENTAL_SWAP_UI,
    NEXT_PUBLIC_FEATURE_EXPERIMENTAL_MARKETPLACE_FILTERS:
      process.env.NEXT_PUBLIC_FEATURE_EXPERIMENTAL_MARKETPLACE_FILTERS,
